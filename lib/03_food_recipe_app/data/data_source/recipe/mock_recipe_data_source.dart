...
final List<Recipe> _recipes = [
  const Recipe(
    ...
    rating: 4.0,
    imagePath:
        'https://cdn.pixabay.com/photo/2022/08/25/17/42/spare-ribs-7410914_1280.jpg', id: '4', ingredients: [],
  ),
  const Recipe(
